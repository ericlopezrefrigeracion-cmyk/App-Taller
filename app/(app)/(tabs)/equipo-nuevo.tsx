...
function Selector({ label, placeholder, options, selectedId, onSelect, disabled }: SelectorProps) {
...
export default function EquipoNuevoScreen() {
  ...
  function handleRubroChange(id: string) {
    setRubroId(id);
    setTipoId('');
  }
  ...
  async function handleGuardar() {
    ...
    try {
      ...
      const msg = e.response?.data?.error || 'No se pudo guardar el equipo';
